          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <button
                ...
                className='px-4 py-2 text-gray-700 font-medium hover:bg-gray-100 transition-colors rounded-lg cursor-pointer'
              >
                로그인
              </button>
              <button
                ...
                className='px-4 py-2 bg-[var(--color-bg-button)] text-white font-medium hover:opacity-90 transition-opacity rounded-lg cursor-pointer'
              >
                회원가입
              </button>
            </>
